...
class CashRegisterPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        return $user->can(LogisticsPermission::ADMIN)
            ...
            || $user->can(LogisticsPermission::CASH_REGISTERS_WRITE);
    }
    ...
    public function view(User $user, CashRegister $cashRegister): bool
    {
        return $this->viewAny($user)
            && $user->tenant_id === $cashRegister->tenant_id;
    }
    ...
    {
        return LogisticsPermission::canWrite($user, LogisticsPermission::CASH_REGISTERS_WRITE);
    }
