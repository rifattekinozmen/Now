...
- [x] Nakit akış projeksiyonu (sipariş tarihi + müşteri vade günü) — `CashFlowProjectionService` + finans özeti tablosu _(basit: 2026-03-29)_
- [ ] Vadeli ödeme takvimi UI / tam muhasebe entegrasyonu.
