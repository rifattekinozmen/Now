...
- [ ] **Tam yasal bilanço / resmi finansal tablolar** — `fiscal_opening_balances` + `LegalFinancialStatementsService` (açılış kayıtları ile BS türü kalemlerin birleştirilmesi); denetim/uyumluluk için ayrı süreç ve uzman onayı gerekir _(kısmi: 2026-03-30)_
